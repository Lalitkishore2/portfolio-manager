export const tokens = {
  // Exact Figma Make & Deconstructivist Portfolio Design Tokens
  color: {
    bg: {
      ...
      input:        '#181818',   // Text inputs & select boxes
      canvas:       '#141414',   // Deep dark canvas workspace
      toolbar:      '#1E1E1E',   // Top header bar
      floatingBar:  'rgba(30, 30, 30, 0.88)', // Floating command pill
    ...
    border: {
      ...
      aiGradient:   'linear-gradient(135deg, #8A3FFC 0%, #D946EF 50%, #0D99FF 100%)',
