  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none z-10 flex items-center justify-center gap-2 w-full h-full">
          {children}
        </div>
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-blue-500 via-blue-600 to-blue-800",
    button: "bg-gradient-to-b from-blue-400 to-blue-500/40",
    textColor: "text-white",
